...
inline unsigned int getReadback(ReadBack_Status status)
{
  switch (status)
  {
  case ReadBack_Status::OVERLOAD: return (0); break;
  case ReadBack_Status::ERROR: return (1); break;
  case ReadBack_Status::TIMEOUT: return (2); break;
  case ReadBack_Status::NORMAL: return (3); break;
  case ReadBack_Status::OUT_OF_INDEX: return (4); break;
  case ReadBack_Status::WRONG_CRC: return (5); break;
  case ReadBack_Status::HEADER_L_INCORRECT: return (6); break;
